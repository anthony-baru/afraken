		...
		@if(!empty(Session::get('similars')))
			...
			@endforeach
				...
				<div style="padding-top: 10px" class="panel panel-success">
					<div class="panel-heading">{{$sub_category->name}}</div>
							...
							<div class="col-md-5">
								<select id="category_id" name="category_id" class="form-control" value="{{ old('category_id') }}">
									...
									@if(isset($categories))
										...
										<option value="{{$category->id}}" <?php if(old('category') != null){if(old('category') == $category->id){ echo 'selected="selected"';}}else if($sub_category->id== $category->id){ echo 'selected="selected"';} ?>>
