				  ...
				  <?php $exam_env = (new \App\Classes\Data\AfrakenData())->GetAfrakenEnv();
		                                 $photo_url=null;
		                                  if(isset($gallery->photo)){
					                        ...
					                        $key='uploads/files/photo/'.$gallery->photo->url;
                                            $s3 = Storage::disk('s3');
                                            $photo_url=$s3->getDriver()->getAdapter()->getClient()->getObjectUrl($bucket, $key);
				                            }else{
					                      $photo_url=asset('uploads/files/images/'.$gallery->photo->url);
				                          }
		                                  }?>
					<img src="{{$photo_url}}" alt="" />
					<div class="single_caption">
						<h1>{{$gallery->title}}</h1>
						<h2>{{$gallery->sub_committee->name}}</h2>
				...
				<div class="row">
					...
					<div class="col-xs-12 custom_right">
						<div class="single_content_left">
							<div class="tab_menu">
								<ul>
									<li class="active"><a href="#explore_program" data-toggle="tab">Description</a></li>
