...
<div style="padding-top: 20px;padding-bottom: 50px" class="col-md-10 col-md-offset-1">
				<div  class="panel panel-success">
					<div class="panel-heading">@if( $account->user()->first()->hasRole('Chairman')) Chairman {{$account->chairman->sub_committee->name}} Sub Committee @else Profile @endif</div>
								...
								<div class="col-md-12">
									...
									<div class="row account-item">
										...
										<div class="row account-item">
											...
											<div class="col-md-6"> <a href="{{url('/administrator/edit-profile')}}" class="btn btn-sm btn-primary"> Edit Profile</a> </div>
										</div>
									</div>
