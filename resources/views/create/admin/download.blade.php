             ...
             <div class="col-md-10 col-md-offset-1">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<form  enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('/administrator/upload-download') }}">
						...
						<div class="form-group {{$errors->has('download') ? 'has-error' : ''}}">
								<label class="col-md-3 control-label" for="download">File (pdf)</label>
								<div class="col-md-7">
									...
									@else
										<span class="help-block" id = "download_help"></span>
									@endif
								</div>
							</div>
						...
						<div class="form-group">
							<div class="col-md-7 col-md-push-3">
								<button type="submit" class="btn btn-sm btn-success"onclick="waitingDialog.show('Please Wait', {dialogSize: 'sm', progressType: 'warning'})"><span class="glyphicon glyphicon-cloud-upload"></span>  Upload</button>
							</div>	
						</div>
					</form>
					</div>
