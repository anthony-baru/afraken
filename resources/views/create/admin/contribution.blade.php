					...
					<div class="panel-body">
						...
						<div class="panel panel-default">
							<div class="row">
								<div class="panel-body">
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ url('/administrator/store-contribution') }}" autocomplete="off">
						...
						<div class="form-group">
							...
							<div class="form-group{{ $errors->has('account_id') ? ' has-error' : '' }}">
                                    <label for="account_id" class="col-md-2 control-label">
                                        Member </label>
                                    <div class="input-group custom-search-form col-md-6">
                            <input id="id" name="id" type="text" class="typeahead form-control" placeholder="Search Member...">
						...
						@if ($errors->has('account_id'))
                          ...
                          <input class="form-control"  id="date" type="text" name="date" placeholder="Payment Date" value="{{ old('date') }}" readonly>
					 ...
					 @if ($errors->has('date'))
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
										...
										<input id="amount" type="number" step="0.01" min="1" class="form-control" placeholder="Amount Paid" name="amount" value="{{ old('amount') }}">
								...
								<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="description">
													...
													<option value="Annual Contribution" {{old('description') == 'Annual Contribution' ? 'selected="selected"':''}}>Annual Contribution</option>
													<option value="Registration Fee" {{old('description') == 'Registration Fee' ? 'selected="selected"':''}}>Registration Fee</option>
...
<script type="text/javascript">
    var path = "{{ route('administrator.member-autocomplete') }}";
