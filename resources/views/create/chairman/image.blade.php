            ...
            <div class="container">
               ...
               <div style="padding-top: 50px;padding-bottom: 50px"  class="col-md-12">
				<div class="panel panel-success">
					<div class="panel-heading">Add {{Auth::user()->account()->first()->chairman->sub_committee->name}} Sub Committee Image To Gallery</div>
					<div class="panel-body">
						...
						<div class="panel panel-default">
							<div class="row">
								<div class="panel-body">
					<div class="row">
						<form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ url('/chairman/store-image') }}">
						...
						<div class="form-group">
                          ...
                          <input class="form-control"  id="date" type="text" name="date" placeholder="Date" value="{{ old('date') }}" readonly>
