            ...
            <div class="container">
               ...
               <div style="padding-top: 50px;padding-bottom: 50px"  class="col-md-12">
				<div class="panel panel-success">
					<div class="panel-heading">Create {{Auth::user()->account()->first()->chairman->sub_committee->name}} Sub Committee Event</div>
					<div class="panel-body">
						...
						<div class="panel panel-default">
							<div class="row">
								<div class="panel-body">
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ url('/chairman/store-event') }}">
						...
						<div class="form-group">
							...
							<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
										...
										<input id="title" type="text" class="form-control" placeholder="Event Title" name="title" value="{{ old('title') }}">
                          ...
                          <input class="form-control"  id="date" type="text" name="date" placeholder="Time" value="{{ old('date') }}" readonly>
					 ...
					 @if ($errors->has('date'))
                                ...
                                @endif
                                    ...
                                    <div class="col-md-6">
										...
										<input id="venue" type="text" class="form-control" placeholder="Event Venue" name="venue" value="{{ old('venue') }}">
								...
								<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
										...
										<textarea id="description" class="form-control" rows="8" cols="8" name="description" placeholder="Event Description.">{{old('description')}}</textarea>
						...
						<div class="form-group">
							<div class="col-md-7 col-md-push-3">
								<button type="submit" class="btn btn-sm btn-success" onclick="waitingDialog.show('Please Wait', {dialogSize: 'sm', progressType: 'warning'})">Add</button>
