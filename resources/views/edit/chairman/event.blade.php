            ...
            <div class="container">
               ...
               <div style="padding-top: 50px;padding-bottom: 50px"  class="col-md-12">
				<div class="panel panel-success">
					<div class="panel-heading">Edit {{Auth::user()->account()->first()->chairman->sub_committee->name}} Sub Committee Event</div>
					<div class="panel-body">
						...
						<div class="panel panel-default">
							<div class="row">
								<div class="panel-body">
					<div class="row">
						<form class="form-horizontal" role="form" method="POST" action="{{ url('/chairman/update-event/'.$event->id) }}">
						...
						<div class="form-group">
							...
							<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
										...
										<input id="title" type="text" class="form-control" placeholder="Event Title" name="title" value="{{ old('title') == null ? $event->title : old('title') }}">
								...
								<?php 
										...
										$date=date_create_from_format('Y-m-d H:i:s',$event->date);
										$date = date_format($date, 'd-m-Y H:i');
									?>
									<div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}">
                                    <label for="date" class="col-md-2 control-label">
                                        Date </label>
                                <div class="input-group date form_datetime col-md-6"  data-date-format="dd-mm-yyyy h:i" data-link-field="dtp_input1">
                          <input class="form-control"  id="date" type="text" name="date" placeholder="Time" value="{{ old('date') == null ? $date : old('date') }}" readonly>
					...
					<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					 @if ($errors->has('date'))
                                ...
                                @endif
                                    ...
                                    <label for="venue" class="col-md-2 control-label">
                                        Venue </label>
                                    <div class="col-md-6">

										<input id="venue" type="text" class="form-control" placeholder="Event Venue" name="venue"  value="{{ old('venue') == null ? $event->venue : old('venue') }}">
								...
								<div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
										...
										<textarea id="description" class="form-control" rows="8" cols="8" name="description" placeholder="Event Description."> {{ old('description') == null ? $event->description : old('description') }}</textarea>
