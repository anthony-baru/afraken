        ...
        <div class="col-lg-12" style="background:#fff">
            <div class="form-wrap">
                <div class="panel panel-default">
                    <form role="form" class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}"
                        autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="row" style="padding-top: 5px">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    <label style="color:#000" for="last_name" class="col-sm-4 control-label">
                                        Last Name</label>
                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="degree">
                                            ...
                                            <option value="Bachelors"
                                                {{old('degree') == 'Bachelors' ? 'selected="selected"':''}}>Bachelors
                                            </option>
                                            <option value="Masters"
                                                {{old('degree') == 'Masters' ? 'selected="selected"':''}}>Masters
                                            </option>
                                            <option value="Doctoral"
                                                {{old('degree') == 'Doctoral' ? 'selected="selected"':''}}>Doctoral
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('employer') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input id="employer" type="text" class="form-control" name="employer"
                                            placeholder="Employer" value="{{ old('employer') }}">
                                ...
                                <div class="form-group{{ $errors->has('payment') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control" name="payment" onChange="check(this.value)">
                                            ...
                                            <option value="Mpesa"
                                                {{old('payment') == 'Mpesa' ? 'selected="selected"':''}}>Mpesa</option>
                                            <option value="Cash"
                                                {{old('payment') == 'Cash' ? 'selected="selected"':''}}>Cash</option>
                                            <option value="Cheque"
                                                {{old('payment') == 'Cheque' ? 'selected="selected"':''}}>Cheque
                                            </option>
                                        </select>
                                ...
                                <div id="hidden-div" style="display:none;"
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input id="code" type="text" class="form-control"
                                            placeholder="Mpesa Payment Code" name="code" value="{{ old('code') }}">
                                ...
                                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    <label style="color:#000" for="password_confirmation"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        By clicking Register, you agree with our <a target="blank"
                                            href="{{URL::asset('uploads/files/static/afraken_privacy_policy.pdf')}}">Terms
                                        </a>
